...
# 파일 경로 설정
answer_file = "/Users/zs_olef.x/Work/Python/디지털인문학을_위한_데이터처리와분석/assignment5_연도별단어빈도/result_copy.txt"
my_file = "/Users/zs_olef.x/Work/Python/디지털인문학을_위한_데이터처리와분석/assignment5_연도별단어빈도/result.txt"
